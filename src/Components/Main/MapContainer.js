...
class MapContainer extends Component {
  ...
  */
    ...
    /* *** *** *** MAP *** *** *** */
    // To create a map I followed this awesome blog post, which is part of official
    // documentation:
  ...
  */
    initMap = () => {
        if (this.props && this.props.google) {
            ...
            // Getting the location to put new map in -> Looking for element with reference
            // = 'map' prop and when found, naming it mapNode WHY? src:
            ...
            const infoWindow = new google
                .maps
                .InfoWindow({maxWidth: 250, maxHeight: 300});
    ...
    getMarkerDetails = marker => {
        ...
        axios
            ...
            .then(res => {
                ...
                let phoneInfo = phone.phone !== undefined
                ...
                let urlInfo = url !== undefined
                    ? `<a href=${url} target="_blank">${url}</a>`
                    : "";
                let ratingInfo = rating !== undefined
                    ? `<span><b>${rating}</b></span>`
                    : "not available";
                let imgInfo = img !== undefined
...
If that doesn't help - oh well -we've very probably exceeded the number of daily requests.`
   ...
   */
    ...
    // TODO-> on change of filter update markers and list; and on click on the list
    // automatically close the sideNav and openInfoWindow
    /*
   ...
   */
    ...
    filterMarkers = (id) => {
        ...
        if (id !== this.state.selectedArray && id !== allPlaces) {
